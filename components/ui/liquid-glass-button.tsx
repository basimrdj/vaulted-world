  ...
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
  {
    variants: {
      ...
      size: {
        ...
        hero: "h-[68px] rounded-full px-14 has-[>svg]:px-8",
        icon: "size-9",
      },
    },
    defaultVariants: {
...
function LiquidButton({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn(
        "group relative active:translate-y-1",
    ...
    >
      <div
        className="absolute top-0 left-0 z-0 h-full w-full rounded-full
            shadow-[0_0_6px_rgba(0,0,0,0.03),0_2px_6px_rgba(0,0,0,0.08),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.9),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.85),inset_1px_1px_1px_-0.5px_rgba(0,0,0,0.6),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.6),inset_0_0_6px_6px_rgba(0,0,0,0.12),inset_0_0_2px_2px_rgba(0,0,0,0.06),0_0_12px_rgba(255,255,255,0.15),0_4px_0_0_rgba(0,0,0,0.25),0_8px_20px_-4px_rgba(0,0,0,0.2)]
        transition-all group-active:shadow-[0_0_6px_rgba(0,0,0,0.03),0_1px_3px_rgba(0,0,0,0.06),inset_3px_3px_0.5px_-3px_rgba(0,0,0,0.9),inset_-3px_-3px_0.5px_-3px_rgba(0,0,0,0.85),inset_1px_1px_1px_-0.5px_rgba(0,0,0,0.6),inset_-1px_-1px_1px_-0.5px_rgba(0,0,0,0.6),inset_0_0_6px_6px_rgba(0,0,0,0.12),inset_0_0_2px_2px_rgba(0,0,0,0.06),0_0_8px_rgba(255,255,255,0.1),0_0px_0_0_rgba(0,0,0,0),0_2px_6px_-2px_rgba(0,0,0,0.1)]"
      />
      <div className="absolute bottom-0 left-[6%] right-[6%] z-[1] h-px rounded-full bg-white/[0.08] transition-opacity duration-150 group-active:opacity-0" />
      <div
