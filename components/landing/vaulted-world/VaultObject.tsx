...
interface Card3DProps {
  ...
  vaultXRef: MutableRefObject<number>; // vault's current x position for burst origin
  totalCards: number;
}
...
function Card3DWithRoundedBox({
  ...
  useFrame(() => {
    ...
    const origin = new THREE.Vector3(vaultXRef.current, 0, 0.5);
